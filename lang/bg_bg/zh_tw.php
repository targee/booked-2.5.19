...
class zh_tw extends en_us
{
  ...
  // End Day representations
	...
	$strings['ResourceAvailability'] = '資源狀態';
	$strings['Available'] = '可用資源';
	$strings['Unavailable'] = '不可用資源';
	$strings['UnavailableAllDay'] = '已預約整天的資源';
	$strings['AllNoUpcomingReservations'] = '在接下來的%s天內沒有即將到期的預訂';
	$strings['AllUpcomingReservations'] = '所有即將到期的預訂資源';	
	$strings['ResourceFilter'] = '資源過濾';
	$strings['ClearFilter'] = '清除過濾';
	$strings['AdvancedFilter'] = '進階過濾';
	$strings['MinimumCapacity'] = '最小容量';
	$strings['ResourceType'] = '資源類型';
